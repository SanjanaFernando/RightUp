...
const STATS = [
  { value: "1200", suffix: "+", label: "Australian Businesses Engaged" },
  { value: "60",   suffix: "+", label: "Magazine Features Published" },
  { value: "25",   suffix: "+", label: "Industry & Global Network Partners" },
  { value: "15",   suffix: "+", label: "Countries Connected Through Our Network" },
];
...
export default function StatsBar() {
  return (
    <ScrollReveal className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 sm:mt-[66px] mb-16">
            ...
            {STATS.map((stat, idx) => (
              ...
              >
                <div className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white tracking-tight mb-2">
                  ...
                  <motion.span
                    className="text-green-500 font-bold ml-0.5"
