      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-[2.5rem] bg-[#0A101D] border border-white/10 shadow-2xl ">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 items-stretch">
            {/* Left Column: Timeline / Feature points */}
            <div className="lg:col-span-7 flex flex-col justify-center p-6 sm:p-10 lg:p-14 lg:pr-8">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white tracking-tight uppercase mb-3">
                WHY CHOOSE RIGHTUP?
              </h2>
              <p className="text-sm sm:text-base text-gray-300 mb-10 max-w-xl leading-relaxed">
                RightUp empowers ambitious businesses to connect, gain visibility, and unlock real growth.
              </p>

              {/* Timeline Items */}
              <div className="relative pl-6 sm:pl-8 space-y-8 before:absolute before:left-3 sm:before:left-4 before:top-3 before:bottom-3 before:w-[2px] before:bg-green-500/30">
                {FEATURES.map((feature, idx) => {
                  const Icon = feature.icon;
                  return (
                    <div key={idx} className="relative flex items-start gap-4 sm:gap-6 group">
                      {/* Icon Circle on Timeline */}
                      <div className="absolute -left-6 sm:-left-8 w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-green-600 text-black flex items-center justify-center ring-4 ring-[#0A101D] shadow-[0_0_12px_rgba(0,220,130,0.5)] group-hover:scale-110 transition-transform">
            ...
            <div className="lg:col-span-5 relative flex justify-end mt-10 lg:mt-0 p-6 sm:p-10 lg:p-0 lg:ml-8">
              <div className="relative w-full aspect-[4/5] lg:aspect-auto h-full rounded-[2rem] lg:rounded-none  overflow-hidden border-y border-l border-white/10 shadow-2xl">
                <Image
              ...
              {/* Experience Badge */}
              <div className="absolute mt-[-40px] ml-[240px] translate-y-1/2 translate-x-1/2 bg-blue-900 text-white px-5 py-3  shadow-xl flex items-center gap-2 z-10 lg:top-6 lg:right-auto lg:left-0 lg:-translate-x-1/2 lg:-translate-y-0">
